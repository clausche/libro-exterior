...
class CiudadPresenter extends BasePresenter
{
    /**
    ...
    {
        return URL::route('ciudades.edit', [ $this->resource->slug ]);
    }
    /**
     * Get the edit link for this trick.
     *
    ...
    {
        return URL::route('ciudades.delete', [ $this->resource->slug ]);
    }

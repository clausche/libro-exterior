# [Libro-Exterior](http://www.laravel-tricks.com)

Libro Exterior is a website created by [Stidges](https://twitter.com/stidges) and [Maksim Surguy](http://twitter.com/msurguy) as an unofficial repository of tips and tricks for web developers using the [Laravel](http://laravel.com) PHP framework.
...
The features of [Libro-Exterior](http://www.laravel-tricks.com) are:
...
The Libro-Exterior website requires a server with PHP 5.4+ that has the MCrypt extension installed.
...
### Standards
The Libro-Exterior application is [PSR-2](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-2-coding-style-guide.md) compliant (and PSR-0 and PSR-1, which PSR-2 extends).
...
Keep track of development and Libro-Exterior news.
